			...
			positions: [
				{
					...
					positionBullets: [
						...
						'Contributed to the end-to-end development of user-friendly websites as a front-end developer using React, Semantic-UI-React, jQuery, and Bootstrap to ensure the implementation of dynamic and user-friendly interfaces for users from 150+ organizations.'
					]
				},
				{
